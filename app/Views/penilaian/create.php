<div class="modal-header bg-primary text-white">
    <h5 class="modal-title fw-bold">Tambah Penilaian</h5>
    <button type="button" class="btn-close text-white" data-bs-dismiss="modal" aria-label="Close"></button>
</div>
<div class="modal-body">
    <form id="form-penilaian" action="<?= site_url('penilaian/store') ?>" method="post">
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control rounded border border-secondary" id="nilai" name="nilai" step="0.01" required>
        </div>
