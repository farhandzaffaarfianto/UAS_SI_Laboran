...
<div class="modal-body">
    <form id="form-kriteria" action="<?= site_url('kriteria/update/'.$kriteria['id_kriteria']) ?>" method="post">
        <div class="mb-3">
            <label for="nama_kriteria" class="form-label fw-semibold">Nama Kriteria</label>
            <input type="text" class="form-control rounded border border-secondary" id="nama_kriteria" name="nama_kriteria" value="<?= $kriteria['nama_kriteria'] ?>" required>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control rounded border border-secondary" id="bobot" name="bobot" value="<?= $kriteria['bobot'] ?>" step="0.01" required>
        </div>
